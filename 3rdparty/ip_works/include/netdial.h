...
class NetDialW : public NetDial {
  ...
  public: //properties
    ...
    inline int SetCallbackNumber(LPWSTR lpCallbackNumber) {
    ...
    inline int SetDomain(LPWSTR lpDomain) {
    ...
    inline int SetEntryDeviceName(LPWSTR lpEntryDeviceName) {
    ...
    inline int SetEntryDeviceType(LPWSTR lpEntryDeviceType) {
    ...
    inline int SetEntryDNSServer(LPWSTR lpEntryDNSServer) {
    ...
    inline int SetEntryIPAddress(LPWSTR lpEntryIPAddress) {
    ...
    inline int SetEntryPhoneNumber(LPWSTR lpEntryPhoneNumber) {
    ...
    inline int SetEntryWINSServer(LPWSTR lpEntryWINSServer) {
    ...
    inline int SetPhonebook(LPWSTR lpPhonebook) {
    ...
    inline int SetPhonebookEntry(LPWSTR lpPhonebookEntry) {
    ...
    inline int SetPhoneNumber(LPWSTR lpPhoneNumber) {
