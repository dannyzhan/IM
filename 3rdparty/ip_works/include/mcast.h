...
class MCast {
  ...
  public: //methods
    ...
    inline int Send(const char* lpText, int lenText) {
      ...
      return IPWorks_MCast_Do(m_pObj, 4, 1, param, cbparam);
...
class MCastW : public MCast {
  ...
  public: //properties
    ...
    inline int SetMulticastGroup(LPWSTR lpMulticastGroup) {
    ...
    inline int SetReceiveInterface(LPWSTR lpReceiveInterface) {
    ...
    inline int SetSendInterface(LPWSTR lpSendInterface) {
  ...
  public: //methods
    ...
    inline int Send(LPWSTR lpText, int lenText) {
      ...
      int cbparam[1+1] = {lenText, 0};
      return IPWorks_MCast_Do(m_pObj, 10000+4, 1, param, cbparam);
